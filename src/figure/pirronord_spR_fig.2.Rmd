...
fig2a <- ggplot(foo, aes(x=patina, color=patina)) + geom_bar(fill="grey", show.legend=FALSE) + facet_grid(layer ~ .) + ggtitle("a") + xlab("Patina") + ylab("Count")
fig2a
...
fig2c <- ggplot(bar, aes(x=integrity, color=integrity)) + geom_bar(fill="grey", show.legend=FALSE) + facet_grid(layer ~ .) + ggtitle("c") + xlab("Integrity") + ylab("Count")
fig2c
